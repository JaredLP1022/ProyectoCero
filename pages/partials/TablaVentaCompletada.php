...
$comando = $PDO->query("SELECT * FROM venta WHERE archivada = 'Desarchivado' AND estado = 'Completada' ");
$comando->execute();
...
<div class="contenedorPanel">
    ...
    <div class="tituloCss">
        <h4 class="text-center ColorLetra">Lista de Ventas Completada</h4>
    </div>
    <div class="botonCss">
...
<div class="container">
    <button title="Descargar Tabla" class=" border-white botonCerrar ColorLetra" type="submit"
        onclick="location.href='AccionesClientes/descargarVentaC.php'">ventas completadas
