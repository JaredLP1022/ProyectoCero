...
$comando = $PDO->query("SELECT * FROM venta WHERE archivada = 'Desarchivado' AND (estado = 'En proceso' OR estado = 'Cancelada')");
...
<div class="container">
  ...
  <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
    ...
    <button title="Reporte Por Producto" class=" border-white botonCerrar ColorLetra" onclick="location.href='ReporteVC.php'" >Reporte por cliente
    </button>
